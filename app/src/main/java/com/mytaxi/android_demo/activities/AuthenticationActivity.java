...
public class AuthenticationActivity extends AppCompatActivity {
    ...
    CountingIdlingResource idlingResource_user = new CountingIdlingResource("user_loader");
    @Inject
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Log.i("az", "I am in onCreate of Authentication Act");
    ...
    public CountingIdlingResource getIdlingResourceForAuthActivity(){
